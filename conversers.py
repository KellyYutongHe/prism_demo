...
class TargetLM():
    ...
    def get_response_lm(self, prompts_list):
    ...
    def get_response(self, prompts_list):
        outputs_list = self.model.batched_generate(prompts_list)
        return outputs_list
...
def load_indiv_model(model_name, device=None):
    ...
    if model_name in ["gpt-3.5-turbo", "gpt-4", "gpt-4-vision-preview", "gpt-4o-mini"]:
        ...
        lm = DALLE(model_name)
    elif model_name in ["sdxl-turbo"]:
        lm = StableDiffusion(model_path)
    else:
